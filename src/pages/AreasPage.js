  ...
  return (
    <div>
      <Helmet>
        ...
        <meta name="description" content="We buy salvage, damaged, and MOT failure cars from every region, county, and town in the UK. Find your local area and get an instant quote today." />
      </Helmet>
      <Container className="py-5">
        <h1 className="text-center mb-4">Nationwide Salvage Car Collection</h1>
        <p className="text-center lead mb-5">
          We have agents in every corner of the country, ready to offer you a great price for your salvage vehicle. Find your area below to learn more and get an instant, no-obligation quote.
        </p>
        <Row>
